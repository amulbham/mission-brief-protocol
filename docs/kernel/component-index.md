...
| Boot Profile Contract | `kernel/modules/12-boot-profile-contract.md` | `kernel/registry/invariants-1.9.json` · `kernel/registry/boot-profiles-1.9.json` · `kernel/registry/source-manifest-1.9.json` | `kernel/tests/kernel-1.9-boot-profiles-conformance.mjs` · `kernel/tests/boot-profile-cases-1.9.json` · `kernel/tests/kernel-1.9-prompt-format-conformance.mjs` | `docs/kernel/architecture.md` · `docs/kernel/booting.md` · `docs/kernel/prompt-style.md` | PLANNED |
| Prompt presentation provenance | `kernel/changes/011-prompt-formatting.md` | `kernel/registry/boot-profiles-1.9.json` | `kernel/tests/kernel-1.9-prompt-format-conformance.mjs` | `docs/kernel/prompt-style.md` | PLANNED |
| Project direct-boot profile | `kernel/modules/13-project-kernel.md` · `kernel/changes/012-project-profile.md` | `kernel/registry/boot-profiles-1.9.json` · `kernel/registry/invariants-1.9.json` · `kernel/registry/source-manifest-1.9.json` | `kernel/tests/kernel-1.9-project-profile-conformance.mjs` · `kernel/tests/project-boot-cases-1.9.json` | `docs/kernel/booting.md` · `docs/kernel/prompt-style.md` | PLANNED |

...
| Boot Profile Contract | `kernel/modules/12-boot-profile-contract.md` | `kernel/registry/invariants-1.9.json` · `kernel/registry/boot-profiles-1.9.json` · `kernel/registry/source-manifest-1.9.json` | `kernel/tests/kernel-1.9-boot-profiles-conformance.mjs` · `kernel/tests/boot-profile-cases-1.9.json` | `docs/kernel/architecture.md` · `docs/kernel/booting.md` | PLANNED |
